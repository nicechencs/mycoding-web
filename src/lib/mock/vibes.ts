...
export const mockVibes: Vibe[] = [
  {
    id: '1',
    content:
      '刚完成了一个使用Next.js 14的项目，App Router真的太香了！服务端组件和客户端组件的分离让性能提升了不少 🚀',
    author: mockUsers[0],
  ...
  },
  {
    id: '2',
    content:
      '今天学习了Tailwind CSS的自定义配置，发现可以通过plugin系统扩展很多功能。分享一个我写的渐变背景插件 ✨',
    author: mockUsers[1],
  ...
  },
  {
    id: '3',
    content:
      '正在重构一个老项目，从JavaScript迁移到TypeScript。类型安全真的能避免很多运行时错误，强烈推荐！',
    author: mockUsers[2],
  ...
  },
  {
    id: '4',
    content:
      '分享一个Node.js性能监控的小技巧：使用clinic.js工具可以很直观地看到应用的性能瓶颈。附上我的监控截图 📊',
    author: mockUsers[3],
  ...
  },
  {
    id: '5',
    content:
      '刚看完React 18的文档，并发特性真的很强大。Suspense和useTransition的组合让用户体验提升了一个档次 💫',
    author: mockUsers[4],
  ...
  },
  {
    id: '6',
    content:
      '今天尝试了一下新的CSS Grid布局技巧，用subgrid实现了复杂的响应式布局。CSS的发展真的越来越强大了 🎨',
    author: mockUsers[0],
  ...
  },
  {
    id: '7',
    content:
      '正在学习PostgreSQL的窗口函数，功能真的很强大！可以轻松实现复杂的数据分析查询。附上我的学习笔记 📚',
    author: mockUsers[1],
  ...
  },
  {
    id: '8',
    content:
      '用React Native开发的APP终于上线了！跨平台开发真的能节省很多时间，虽然也有一些坑要踩 📱',
    author: mockUsers[2],
