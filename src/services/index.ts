...
export { UsersService, usersService, type UserUpdateData, type UserStats, type UserPreferences } from './users.service';
...
export class ServiceManager {
  static get articles() { return articlesService; }
  static get resources() { return resourcesService; }
  static get vibes() { return vibesService; }
  static get users() { return usersService; }
