...
class ImageCache {
  ...
  set(src: string, status: 'loading' | 'loaded' | 'error', promise?: Promise<HTMLImageElement>, error?: Error) {
    this.cache.set(src, {
      status,
      timestamp: Date.now(),
      promise,
...
export function useLazyImage(
  ...
  }, [preloadOnHover, currentSrc, loadingState, preloadImage, debounce, debounceDelay])
